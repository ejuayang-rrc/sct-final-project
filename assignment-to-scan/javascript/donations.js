...
window.addEventListener("DOMContentLoaded", () => {
  document.getElementById("donation_prompt").classList.add("hidden");
});
function addDonation()
{
  document.getElementById("donation_prompt").classList.remove("hidden");
}
...
// Allows the donations.test.js file to use the function being validated
module.exports = { loadDonationData };

document.getElementById("donation_prompt").addEventListener("submit", (event) => { 
