"""This module defines the LookupWindow class."""
...
class LookupWindow(QMainWindow):
    ...
    def reset_display(self):
        ...
        This function Clears contents of display fields 
        client_number_edit, client_info_label and account_table, 
        and resets focus to the client_number_edit.
